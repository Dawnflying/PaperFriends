...
var PDFPageView = (function PDFPageViewClosure() {
  ...
  function PDFPageView(options) {
    ...
    div.className = 'page';
    div.style.width = Math.floor(this.viewport.width+100) + 'px';
    div.style.height = Math.floor(this.viewport.height) + 'px';
    div.setAttribute('data-page-number', this.id);
    this.div = div;

    var commentContainer = document.getElementById('commentOverlay');
    var divTag = document.createElement('div');

    divTag.id = 'tag' + this.id;
    divTag.className = 'commentTag'

/*    divTag.style.height=30+'px';
    divTag.style.width=30+'px';
    divTag.style.zIndex=40001;
    divTag.style.background='#0000ff';*/
    div.appendChild(divTag);
    container.appendChild(div);
      
//    commentContainer.appendChild(divTag);
  }
  ...
  PDFPageView.prototype = {
    ...
    draw: function PDFPageView_draw() {
      ...
      submit.onclick = function(){
        ...
        {
            var divtag = document.createElement('div');
            divtag.id = 'tag' + this.id + "_" + i.toString();

            var top = 30 + i*200;
            divtag.style.top = top.toString()+"px";
            divtag.style.left="25px";
            divtag.style.width= "48px";
            divtag.style.height="48px";
            divtag.style.zIndex="9999999";
            divtag.style.position="absolute";
            divtag.style.opacity="0.9";

            divtag.onmouseover=function(){
                if(true) this.style.cursor='pointer';
            };

            divtag.style.backgroundImage="url(images/icons/comment_plus_48.png)";
            divtag.onclick=function(){
                var list=document.getElementById('comment-list')
                var listElem = document.createElement('li');

                listElem.innerHTML="<a href=\"\">lixiaofei at 2015-10-07 11：14</a><p>此处对不同种语言做了简介</p>";
            ...
            var divtag = document.createElement('div');
            divtag.id = 'tag' + this.id + "_right" + i.toString();

            var top = 30 + i*200;
            divtag.style.top = top.toString()+"px";
            divtag.style.right="25px";
            divtag.style.width= "48px";
            divtag.style.height="48px";
            divtag.style.zIndex="9999999";
            divtag.style.position="absolute";
